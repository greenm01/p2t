...
proc report(name: string, input: TessInput) =
  ...
  echo &"{name},{points},{triangles},{stats.pointEvents},{stats.locateNodeSteps},{locatePerPoint:.3f},{stats.fills},{stats.fillBasins},{stats.legalizeCalls},{stats.rotations},{stats.edgeEvents},{stats.edgeWalkSteps},{edgeWalkPerEvent:.3f},{stats.flipEvents},{stats.flipScans},{flipScanPerEvent:.3f},{stats.incircleCalls},{stats.inScanAreaCalls},{stats.mapTriangleToNodesCalls},{stats.indexCalls},{stats.edgeIndexCalls},{stats.meshCleanVisits},{stats.swapNeighborScans},{stats.slotRotations},{stats.locateNodeHashHits},{stats.locateNodeHashMisses},{stats.frontBucketUpdates}"
...
echo "case,points,triangles,pointEvents,locateSteps,locateStepsPerPoint,fills,fillBasins,legalizeCalls,rotations,edgeEvents,edgeWalkSteps,edgeWalkStepsPerEvent,flipEvents,flipScans,flipScansPerEvent,incircleCalls,inScanAreaCalls,mapTriangleToNodesCalls,indexCalls,edgeIndexCalls,meshCleanVisits,swapNeighborScans,slotRotations,hashHits,hashMisses,frontBucketUpdates"
